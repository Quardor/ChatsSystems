...
public class ChatsListArguments implements ArgumentType {
    ...
    public boolean isIt(CommandSender commandSender, String[] strings, String s) {
        return DarkAgeChatSystem.getChatsHashMap().containsKey(s);
    }
    ...
    public List<String> tabulation(CommandSender commandSender, String[] strings, String s) {
        return DarkAgeChatSystem.getChatsHashMap().keySet().stream().toList();
    }
}
